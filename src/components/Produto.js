  ...
  render() {
    ...
    return (
      <li className="carrinho-produto">
        ...
        >
          <img src="https://img.freepik.com/free-icon/trash-bin-symbol_318-10194.jpg?size=338&ext=jpg" alt="Deletar produto" />
        </button>
        ...
        <div className="carrinho-produto-quantidade-container">
          ...
          >
            {/* <img id="diminuir" src={ iconeRemover } alt="Remover item" /> */}
          </button>
          ...
          <button
            ...
            type="button"
            id="aumentar"
            className="carrinho-produto-botão-quantidade aumentar"
            onClick={ this.gerenciarQuantidade }
          >
            {/* <img id="aumentar" src={ iconeAdicionar } alt="Adicionar item" /> */}
          </button>
        </div>
      </li>
    );
